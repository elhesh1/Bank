...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(436, 46);
			...
			this->label2->Location = System::Drawing::Point(132, 131);
			...
			// tbEmail
			// 
			this->tbEmail->Location = System::Drawing::Point(293, 124);
			...
			this->label3->Location = System::Drawing::Point(136, 179);
			...
			// tbPassword
			// 
			this->tbPassword->Location = System::Drawing::Point(293, 179);
			...
			// btnOK
			// 
			this->btnOK->Location = System::Drawing::Point(293, 247);
			...
			// btnCancel
			// 
			this->btnCancel->Location = System::Drawing::Point(478, 246);
